...
{
    /// <summary>
    ///     Summary description for Twofish encryption algorithm of which more information can be found at
    ...
    public sealed class Twofish : SymmetricAlgorithm
    {
        ...
        /// <summary>
        ///     Creates an object that supports ICryptoTransform that can be used to encrypt data using the Twofish encryption
        ///     algorithm.
        /// </summary>
        /// <param name="key">A byte array that contains a key. The length of this key should be equal to the KeySize property</param>
        /// <param name="iv">
        ///     A byte array that contains an initialization vector. The length of this IV should be equal to the
        ///     BlockSize property
        /// </param>
        ...
        /// <summary>
        ///     Creates an object that supports ICryptoTransform that can be used to decrypt data using the Twofish encryption
        ///     algorithm.
        /// </summary>
        /// <param name="key">A byte array that contains a key. The length of this key should be equal to the KeySize property</param>
        /// <param name="iv">
        ...
        public override ICryptoTransform CreateDecryptor(byte[] key, byte[] iv)
        {
            ...
            return new TwofishEncryption(KeySize, ref KeyValue, ref IVValue, ModeValue,
                TwofishBase.EncryptionDirection.Decrypting);
        }
