...
namespace UnitTests.FunctionLibTests
{
    ...
    public class HistogramTest
    {
        ...
        {
            var result =
                ImageFunctionLib.GettingHistogramData(new Bitmap(@"C:\Users\marius.schroeder\Desktop\Normal.png"), 3);
            Assert.IsNotNull(result);
            Assert.IsTrue(result.Count > 0);

            var res2 =
                ImageFunctionLib.GettingHistogramData(new Bitmap(@"C:\Users\marius.schroeder\Desktop\Encrypted.png"), 3);
        }
